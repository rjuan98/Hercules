...
def init_db():
    ...
    conn.execute(
        """
        CREATE TABLE IF NOT EXISTS app_auto_login (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            user_id INTEGER NOT NULL,
    ...
    # Ciclo da fatura: dia em que fecha e dia em que vence (vem do banco ou o usuário informa)
    _add_column_if_missing(conn, "usuarios", "cartao_fechamento", "INTEGER")
    _add_column_if_missing(conn, "usuarios", "cartao_vencimento", "INTEGER")
